...
import { Phone, ArrowUpRight, ChevronLeft, ChevronRight } from 'lucide-react';
...
const Hero: React.FC = () => {
  ...
  return (
    <header ref={ref} className={`fullscreen-section section-card ${isInView ? 'in-view' : ''}`}>
      <div className="max-w-[1400px] mx-auto px-6 pt-8 pb-16 grid grid-cols-12 gap-10">{/* Nav and content remain the same */}t from 'react';
import { Phone, ArrowUpRight, ChevronLeft, ChevronRight } from 'lucide-react';
// Temporary placeholder images (replace with actual assets: hero.jpg, service1.jpg, service2.jpg, service3.jpg)
const heroImg = 'https://via.placeholder.com/800x1000.png?text=Hero+Image';
const service1 = 'https://via.placeholder.com/400x300.png?text=Portfolio';
...
const Hero: React.FC = () => {
  return (
    <header className="max-w-[1400px] mx-auto px-6 pt-8 pb-16 grid grid-cols-12 gap-10">
